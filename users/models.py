...
class CustomUser(AbstractUser):
    ...
    street = models.CharField(max_length=500, blank=True, help_text='Add your street and number for exact location (leave it out if you feel uncomfortable with it)')
